...
/**
 * Pre-built FAQ data for common FujiLearn questions
 */
export const commonKanaDOJOFAQs: FAQItem[] = [
  {
    question: 'Is FujiLearn free to use?',
    answer:
      'Yes, FujiLearn is completely free to use. All features including Hiragana, Katakana, Kanji practice, vocabulary training, and the Japanese translator are available at no cost.',
  },
  {
    question: 'Do I need to create an account?',
    answer:
      'No account is required to use FujiLearn. Your progress is saved locally in your browser, so you can start learning immediately without any signup process.',
  },
  {
    question: 'What Japanese writing systems does FujiLearn teach?',
    answer:
      'FujiLearn teaches all three Japanese writing systems: Hiragana (basic phonetic characters), Katakana (used for foreign words), and Kanji (Chinese characters organized by JLPT levels N5-N1).',
  },
  {
    question: 'Can FujiLearn help me prepare for the JLPT?',
    answer:
      'Yes! FujiLearn organizes Kanji and vocabulary by JLPT levels (N5 through N1), making it an excellent tool for JLPT preparation. Practice the specific characters and words you need for your target level.',
  },
  {
    question: 'How does the progress tracking work?',
    answer:
      'FujiLearn automatically tracks your learning progress, including accuracy rates, practice time, and mastered characters. All data is stored locally in your browser and remains private.',
  },
  {
    question: 'Does FujiLearn work offline?',
    answer:
      'FujiLearn works best with an internet connection, but core features like character practice are available offline once the page has loaded. Your progress is always saved locally.',
  },
  {
    question: 'What is the Japanese translator feature?',
    answer:
      'The FujiLearn translator converts between English and Japanese, providing translations in Hiragana, Katakana, and Kanji, along with Romaji pronunciation. It is free to use without any signup.',
  },
  {
    question: 'Can I customize the appearance of FujiLearn?',
    answer:
      'Yes! FujiLearn offers 100+ themes and multiple font options to personalize your learning experience. Find the style that works best for you in the Preferences section.',
  },
];
...
export const hiraganaFAQs: FAQItem[] = [
  ...
  },
  {
    question: 'How long does it take to learn Hiragana?',
    answer:
      'With consistent daily practice, most learners can memorize all 46 Hiragana characters in 1-2 weeks. FujiLearn provides interactive games and exercises to help you master Hiragana efficiently.',
  },
  {
