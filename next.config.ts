...
const cspEnforced =
  "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https:; style-src 'self' 'unsafe-inline' https:; img-src 'self' data: blob: https: https://assets.fujilearn.com; font-src 'self' data: https:; connect-src 'self' https:; frame-src 'self' https:; object-src 'none'; base-uri 'self';";
...
const cspReportOnly = [
  ...
  "img-src 'self' data: blob: https: https://assets.fujilearn.com",
