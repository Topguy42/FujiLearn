...
1. **Learning tool** - [FujiLearn](/) for interactive practice (free!)
...
1. Learn the 5 vowels (あいうえお)
   ...
   - Write each 5 times
   - Use [FujiLearn Pick Mode](/kana/train/pick) for recognition

**Afternoon (15 minutes):** 2. Learn K-row (かきくけこ)

- Notice the pattern: ka, ki, ku, ke, ko
- Write each 5 times
- Practice on FujiLearn
...
- Use FujiLearn's tracking to focus on weak characters
...
- Compete with friends for high scores on FujiLearn
...
**Solution:** This is normal! Use spaced repetition. Review difficult characters more frequently. Focus on the ones you struggle with using FujiLearn's per-character tracking.
...
**Solution:** Even 15 minutes is better than nothing! Use dead time: commute, waiting in line, before bed. FujiLearn works on mobile!
...
- Continue using FujiLearn for speed improvement
...
- Begin with JLPT N5 Kanji on [FujiLearn](/kanji)
...
**Ready to practice?** [Start learning Hiragana on FujiLearn now](/) - it's free and no account needed!
