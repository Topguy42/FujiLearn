...
4. **Use interactive tools** – [FujiLearn's training modes](/en/kana/train) make practice fun
...
Apps like Anki or FujiLearn's built-in system help you review efficiently.
...
- 15 min: Kana/Kanji review with [FujiLearn](/en/kana/train)
...
<table>
  ...
  <tbody>
    <tr>
      <td><strong>[FujiLearn](https://fujilearn.com)</strong></td>
      <td>Web app</td>
      <td>Free</td>
...
<table>
  ...
  <tbody>
    <tr>
      <td><strong>[FujiLearn Vocabulary](/en/vocabulary/train)</strong></td>
      <td>Web app</td>
      <td>Free</td>
...
- [ ] Practice recognition with [FujiLearn](/en/kana/train)
...
- ✅ **Use the right tools** – [FujiLearn](/) for kana, textbooks for grammar
...
**Ready to take the first step?** [Start learning hiragana now with FujiLearn](/en/kana/train) – it's free, fun, and you can begin in seconds!
