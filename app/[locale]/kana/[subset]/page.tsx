...
export async function generateMetadata({
  ...
  // const ogImageUrl = `https://fujilearn.com/api/og?title=${encodeURIComponent(titleShort)}&description=${encodeURIComponent(description.slice(0, 100))}&type=kana`;
  ...
  return {
    ...
    openGraph: {
      title: titleShort,
      description,
      url: `https://fujilearn.com/${locale}/kana/${subset}`,
      type: 'website',
      /* images: [
        {
          url: ogImageUrl,
    ...
    alternates: {
      canonical: `https://fujilearn.com/${locale}/kana/${subset}`,
      languages: {
        en: `https://fujilearn.com/en/kana/${subset}`,
        es: `https://fujilearn.com/es/kana/${subset}`,
      },
    },
  };
}
