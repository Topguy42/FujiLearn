...
export async function generateMetadata() {
  return {
    title: 'How to Use FujiLearn - Complete Tutorial Guide',
    description:
      'Learn how to use FujiLearn effectively with this complete tutorial. Discover all features, training modes, progress tracking, and tips for mastering Japanese Hiragana, Katakana, Kanji, and Vocabulary.',
    keywords:
      'how to use fujilearn, fujilearn tutorial, fujilearn guide, japanese learning tutorial, kana training guide, kanji study guide, fujilearn features',
  };
}
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          {
            name: 'How to Use',
            url: `https://fujilearn.com/${locale}/how-to-use`,
          },
        ]}
      />
      <HowToSchema
        name='How to Learn Japanese with FujiLearn'
        description='A step-by-step guide to using FujiLearn for learning Japanese Hiragana, Katakana, Kanji, and Vocabulary effectively.'
        totalTime='PT30M'
        estimatedCost='0'
        steps={[
          {
          ...
          },
          {
            ...
            text: 'Visit Preferences to change themes, fonts, and other settings. FujiLearn offers 100+ themes to personalize your learning environment.',
          },
        ]}
      />
      <div className='mx-auto max-w-4xl px-4 py-8'>
        <h1 className='mb-4 text-center text-4xl font-bold text-(--main-color)'>
          How to Use FujiLearn
        </h1>
        <p className='mb-8 text-center text-lg text-(--secondary-color)'>
          Your complete guide to mastering Japanese with FujiLearn
        </p>
        ...
        <div className='space-y-8 text-(--secondary-color)'>
          ...
          <section>
            ...
            <p className='mb-4'>
              FujiLearn is designed to be intuitive and easy to use. No account
          ...
          <section>
            ...
            <p className='mb-4'>
              FujiLearn offers 6 different training modes to keep learning
          ...
          <section>
            ...
            <p className='mb-4'>
              FujiLearn automatically tracks your learning progress:
            </p>
          ...
          <section>
            ...
            <p className='mb-4'>Make FujiLearn your own:</p>
            <ul className='list-disc space-y-2 pl-6'>
              <li>
          ...
          <section>
            ...
            <div className='space-y-4'>
              <div>
                ...
                <p>
                  No! FujiLearn works without any account. Your progress is saved
              ...
              <div>
                <h4 className='mb-2 font-semibold text-(--main-color)'>
                  Is FujiLearn really completely free?
                </h4>
                <p>
              ...
              <div>
                <h4 className='mb-2 font-semibold text-(--main-color)'>
                  Can I use FujiLearn offline?
                </h4>
                <p>
                  Yes! FujiLearn works as a Progressive Web App (PWA). Once
              ...
              <div>
                <h4 className='mb-2 font-semibold text-(--main-color)'>
                  How long does it take to learn Japanese with FujiLearn?
                </h4>
                <p>
          ...
          <section className='rounded-lg bg-(--main-color) p-8 text-center text-(--background-color)'>
            ...
            <p className='mb-6 text-lg'>
              Begin your Japanese journey today with FujiLearn&apos;s free
              interactive lessons!
            </p>
